        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlaneDurationCheck", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembersShips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MembersShips_Members_MemberID",
                        column: x => x.MemberID,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembersShips_Planes_PlaneId",
                        column: x => x.PlaneId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembersSessions", x => new { x.MemberId, x.SessionId });
                    table.ForeignKey(
                        name: "FK_MembersSessions_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembersSessions_Sessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembersSessions_SessionId",
                table: "MembersSessions",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_MembersShips_MemberID",
                table: "MembersShips",
                column: "MemberID");

            migrationBuilder.CreateIndex(
                name: "IX_MembersShips_PlaneId",
                table: "MembersShips",
                column: "PlaneId");
